...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   const posts = objetoUsuario.posts; // Paso 1: Obtener el arreglo de posts del objetoUsuario
   let sumarLikesDeUsuario = 0; // Paso 2: Inicializar una variable para almacenar la suma de likes

   for (let i = 0; i < posts.length; i++) { // Paso 3: Recorrer cada post en el arreglo y sumar los likes
      sumarLikesDeUsuario += posts[i].likes || 0; // Accedo a la propiedad "likes" de cada post y la sumo
   } 
